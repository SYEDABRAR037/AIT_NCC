...
const GooeyNav = ({
  ...
  const triggerAnimation = (liEl, index) => {
  ...
  const handleClick = (e, index, item) => {
    const liEl = e.currentTarget.tagName === 'LI' ? e.currentTarget : e.currentTarget.closest('li') || e.currentTarget;
  ...
  const handleKeyDown = (e, index, item) => {
    if (e.key === 'Enter' || e.key === ' ') {
      ...
      handleClick({ ...e, currentTarget: liEl }, index, item);
    }
  };
